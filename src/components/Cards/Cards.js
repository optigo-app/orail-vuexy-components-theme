...
import boatImage from '../../assets/Images/paper-boat.png'
import applewatch from '../../assets/Images/watch-on-hand.jpg'
...
const Cards = () => {
  ...
  return (
    <Box component={'div'} style={{display:'flex',justifyContent:'center',alignItems:'center',marginTop:'100px',gap:'120px'}}>
 <Card sx={{width:'450px'}}>
      <CardMedia sx={{ height: '14.5625rem' }} image={boatImage} />
      <CardContent>
    ...
    <Card sx={{width:'450px'}}>
      <CardMedia sx={{ height: '9.375rem' }} image={applewatch} />
      <CardContent>
        <Typography variant='h5' sx={{ mb: 2 }}>
          Apple Watch
        </Typography>
      ...
      <Button  variant='contained' style={{ backgroundColor:'#7367F0', width: '100%', borderTopLeftRadius: 0, borderTopRightRadius: 0 }}>
        Add To Cart
      </Button>
    </Card>
    </Box>
